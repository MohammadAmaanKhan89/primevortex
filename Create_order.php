...
try {
    ...
    // Step 2: Redirect to Bank Alfalah Secure Page
    ...
    echo $htmlForm;   // This should redirect you

} catch (Throwable $e) {
    apg_update_order($orderRef, ['status' => 'Failed', 'error' => $e->getMessage()]);
    fail_page('Bank Alfalah Error: ' . $e->getMessage());
}