...
return [
    ...
    'sandbox' => [
        ...
        'merchant_id'       => '265397',
        'store_id'          => '560844',
        'merchant_hash'     => 'OUU362MB1urEv2JGNWAMrfLdElW+v9hsxG/F/FH5JaqNwMbHw0nSN9n5OEpVAXgP',
        'merchant_username' => 'opifuv',
        'merchant_password' => 'f4+/gUV1hHNvFzk4yqF7CA==',
        'key1'              => 'C23vk3F3hZk5zsQf', // AES key, exactly 16 chars
        'key2'              => '3540172732654826', // AES IV,  exactly 16 chars
    ],
